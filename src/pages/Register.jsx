    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-950 px-4 transition-colors duration-200">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-2 justify-center mb-8">
          ...
          <span className="text-lg font-semibold text-gray-900 dark:text-white tracking-tight">DashLife</span>
        </div>

        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
          <h1 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-1">Create account</h1>
          <p className="text-sm text-gray-400 dark:text-slate-500 mb-6">Start your free dashboard today</p>
